...
def build_ninja(root: str, globals_map, envs, env_objects, tests, objects_perbits, objects_perenv) -> list[str]:
    ...
    for test in tests:
        ...
        default_targets.append(info_output)
        ...
        for env_name in test.envs:
            ...
            default_targets.append(bin_output)
            ...
            default_targets.append(cfg_output)
            ...
            for variation in test.vary_cfg:
                ...
                default_targets.append(vary_output)

    lines.append("default " + " ".join(default_targets))
    lines.append("")
    return lines
