...
TEST_EXTRA_CFG_$$(TEST_KEY) := $$(if $$(TEST-EXTRA-CFG),$$(CURRENT_TEST_DIR)/$$(TEST-EXTRA-CFG))
TEST_VARY_CFG_$$(TEST_KEY) := $$(VARY-CFG)
TEST_VCPUS_$$(TEST_KEY) := $$(if $$(VCPUS),$$(VCPUS),1)
TEST_LOCAL_OBJ_PERENV_$$(TEST_KEY) := $$(foreach obj,$$(obj-perenv),$$(call xtf_canonicalise_test_obj,$$(obj)))
undefine TEST_KEY
undefine XTF_METADATA_ONLY
undefine CURRENT_TEST_DIR
endef

$(foreach test_makefile,$(TEST_MAKEFILES),$(eval $(call xtf_load_test,$(test_makefile))))